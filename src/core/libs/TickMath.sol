...
library TickMath {
    ...
    //         // this divides by 1<<32 rounding up to go from a Q128.128 to a
    //         // Q128.96.
    //         // we then downcast because we know the result always fits within
    //         // 160 bits due to our tick input constraint
    //         // we round up in the division so getTickAtSqrtRatio of the output
    //         // price is always consistent
