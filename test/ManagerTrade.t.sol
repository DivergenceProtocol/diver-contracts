...
contract ManagerTrade is Mint {
    ...
    function test_BuyShieldCrossTick() public virtual {
        ...
        uint256 sp = specific > 0 ? uint256(specific) : uint256(-specific);
    ...
    function wrapTrade(
        ...
        public
        returns (uint256 cAmount, uint256 sAmount, uint160 latestSqrtPriceX96, int24 latestTick)
    {
    ...
    function test_BuySpearAndShieldToRecoverPriceExactOut(int256 specific) public virtual {
        ...
        (uint256 cAmount2, uint256 sAmount2, uint160 sqrtPriceX96End, int24 tickEnd) = wrapTrade(params2, battleAddr, spear, shield);
